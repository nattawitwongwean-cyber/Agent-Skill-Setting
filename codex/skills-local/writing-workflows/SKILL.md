...
description: Use when an Antigravity-style workflow or skill authoring task is requested in Codex - maps to Superpowers writing-skills
---
...
Use the Codex-native `writing-skills` skill for the real workflow. It covers
