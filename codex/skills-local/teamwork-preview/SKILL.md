...
description: Use when an Antigravity-style teamwork-preview workflow is requested in Codex - maps to the Codex-native subagent-driven-development workflow.
---
...
Use the Codex-native `subagent-driven-development` skill for the real workflow.
