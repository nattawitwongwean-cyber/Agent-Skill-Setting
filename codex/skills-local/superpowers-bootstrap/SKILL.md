...
description: Use when an Antigravity-style Superpowers bootstrap is requested in Codex - maps the bootstrap behavior to Codex's using-superpowers skill
---
...
Use Codex's native `using-superpowers` skill for the actual workflow. It is the
...
3. Prefer Codex-native Superpowers skills in `~/.codex/skills`.
